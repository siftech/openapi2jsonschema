...
def translate(output, schema="schemas", prefix="_definitions.json", stand_alone=False, expanded=False, kubernetes=False, strict=False, root=None, debug=False):
    """
    ...
    if version < "3" and output is not None:
    ...
    for title in components:
        ...
        try:
            ...
            if stand_alone:
                if output is None:
                    specification = JsonRef.replace_refs(specification)
                else:
